        ...
        if (lista.isEmpty()) {
            ...
            binding.spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
                ...
                override fun onItemSelected(
                    ...
                    when(binding.spinner.selectedItem.toString()){
                        "Objeto Random"->{
                            Toast.makeText(this@Mercader, "No puedes vender este objeto", Toast.LENGTH_SHORT).show()
                        }
                        "Espada"->{
                            cantidad = 0
                            ido = "Espada"
...
//                            "Espada"->{
//                                for(i in 0 until cantidad){
//                                    p.mochila.remove(Objetos("Espada", 14, 125, 200))
...
//                            "Escudo"->{
//                                for(i in 0 until cantidad){
//                                    p.mochila.remove(Objetos("Escudo", 10, 100, 250))
...
//                            "Armadura"->{
//                                for(i in 0 until cantidad){
//                                    p.mochila.remove(Objetos("Armadura", 20, 150, 300))
...
//                            "Pocion"->{
//                                for(i in 0 until cantidad){
//                                    p.mochila.remove(Objetos("Pocion", 2, 50, 100))
